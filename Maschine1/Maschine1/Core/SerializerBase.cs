...
namespace Maschine1.Core
{
    public class SerializerBase
    {
        ...
        { throw new NotImplementedException("CloseInputStream"); }
        ...
        public virtual void WriteData(string Name, double Data) { }
        /// <summary>
        ...
        public virtual double ReadAsDouble(string Name) { return 0; }
        #endregion
    ...
    public class SerializerXML : SerializerBase
    {
        ...
        public override void WriteData(string Name, double Data) {
            m_Writer.WriteAttributeString(Name, Data.ToString());
        }
        ...
        public override double ReadAsDouble(string Name) {
            if (!m_Reader.MoveToAttribute(Name)) return 0;
            return m_Reader.ReadContentAsDouble();
        }
        #endregion
